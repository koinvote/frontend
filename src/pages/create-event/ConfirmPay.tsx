          ...
          <div className="mt-6 space-y-4">
            ...
            {state.isRewarded && rewardAmountSatoshi > 0 && (
              <div className="space-y-1">
                <div className="tx-12 lh-18 text-secondary">{t("confirmPay.rewardAmount", "Reward Amount")}</div>
                <div className="tx-14 lh-20 text-primary">
            ...
            {state.enablePreheat &&
              ...
              preheatFeeSatoshi > 0 && (
                <div className="space-y-1">
                  <div className="tx-12 lh-18 text-secondary">{t("confirmPay.preheatFee", "Preheat Fee")}</div>
                  <div className="tx-14 lh-20 text-primary">
            ...
            {showPlatformFee && (
              <div className="space-y-1">
                <div className="tx-12 lh-18 text-secondary">{t("confirmPay.platformFee", "Platform Fee")}</div>
                <div className="tx-14 lh-20 text-primary">
            ...
            {/* Total Amount */}
            <div className="space-y-1">
              <div className="tx-12 lh-18 text-secondary">{t("confirmPay.totalAmount", "Total Amount")}</div>
            ...
            {/* Refund Address */}
            <div className="space-y-1">
              <div className="tx-12 lh-18 text-secondary">{t("confirmPay.refundAddress", "Refund Address")}</div>
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <div className="tx-12 lh-18 text-secondary">{t("confirmPay.sendExactly", "Send exactly")}</div>
              ...
              <div className="flex items-start gap-2 tx-12 lh-18 text-secondary">
                ...
                <span>
                  {t("confirmPay.warning", "Do NOT split your payment. Transactions below {{threshold}} BTC will NOT trigger a refund.", { threshold: refundThresholdBtc })}
                </span>
              </div>
