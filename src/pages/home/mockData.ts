...
import { mapBackendEventToEventSummary } from "@/utils/eventTransform";
import {
  applySearchFilter,
  applyHashtagFilter,
  applySort,
...
export const MOCK_BACKEND_EVENTS: BackendEvent[] = [
  // === Ongoing 1 ===
  {
    ...
    top_replies: [
      {
        id: 1,
        body: "Based on historical data, we typically see a 20–30% drop in hashrate initially, followed by gradual recovery.",
        weight_percent: 42,
        amount_btc: 400_000, // 0.00400000
      },
      {
        id: 2,
        body: "Smaller, less efficient miners will be forced out unless fees pick up significantly.",
        weight_percent: 31,
  ...
  // === Ongoing 2 ===
  {
    ...
    title:
      "What's the best Lightning Network wallet for small businesses in 2024?",
    description:
    ...
    top_replies: [
      ...
      {
        id: 4,
        body: "If you prefer something simpler for staff, Phoenix might be easier to train on.",
        weight_percent: 27,
        amount_btc: 300_000, // 0.00300000
      },
    ],
  ...
  // === Completed 1 ===
  {
    ...
    top_replies: [
      ...
      {
        id: 6,
        body: "Base case around 60k–90k with periods of high volatility and deep corrections.",
        weight_percent: 26,
  ...
  // === Ongoing 3 ===
  {
    ...
    top_replies: [
      {
        id: 7,
        body: "Use loop-out + circular rebalances scheduled during low-fee windows.",
        weight_percent: 52,
        amount_btc: 490_000, // 0.00490000
      },
      {
        id: 8,
        body: "Automate with LNDg or similar tools and set clear target policies per peer.",
        weight_percent: 29,
  ...
  // === Ongoing 4 ===
  {
    ...
    top_replies: [
      {
        id: 9,
        body: "Expect periodic spikes but not a permanent new floor until more L2 activity settles on-chain.",
        weight_percent: 41,
        amount_btc: 280_000, // 0.00280000
      },
      {
        id: 10,
        body: "As long as blockspace is scarce, any competing use case helps bootstrap a real fee market.",
        weight_percent: 33,
  ...
  // === Ongoing 5 ===
  {
    ...
    top_replies: [
      {
        id: 11,
        body: "Single hardware wallet today, with a clear path to 2-of-3 multisig later when balance grows.",
        weight_percent: 47,
        amount_btc: 840_000, // 0.00840000
      },
      {
        id: 12,
        body: "Focus on solid backups and inheritance instructions before fancy multisig setups.",
        weight_percent: 30,
  ...
  // === Completed 2 ===
  {
    ...
    top_replies: [
      {
        id: 13,
        body: "Most usage is still aggregating key-path spends; script-path usage remains niche but growing.",
        weight_percent: 44,
        amount_btc: 440_000, // 0.00440000
      },
      {
        id: 14,
        body: "Wallet support is the main bottleneck; large custodians are slower to adopt.",
        weight_percent: 28,
        amount_btc: 280_000, // 0.00280000
      },
    ],
  ...
  // === Completed 3 ===
  {
    ...
    top_replies: [
      {
        id: 15,
        body: "Roughly 70–80% on L2s in markets with mature Lightning infrastructure.",
        weight_percent: 40,
        amount_btc: 600_000, // 0.00600000
      },
      {
        id: 16,
        body: "On-chain payments below $50 will be rare outside of very low-fee periods.",
        weight_percent: 25,
  ...
  // === Completed 4 ===
  {
    ...
    top_replies: [
      {
        id: 17,
        body: "Rough estimate: 60–70% remain fully custodial after 12 months.",
        weight_percent: 37,
        amount_btc: 330_000, // 0.00330000
      },
      {
        id: 18,
        body: "Only a minority move to self-custody unless there is a strong local education push.",
        weight_percent: 29,
  ...
  // === Completed 5 ===
  {
    ...
    top_replies: [
      {
        id: 19,
        body: "Most credible estimates put renewables and stranded energy at 45–60% of total hashrate.",
        weight_percent: 48,
        amount_btc: 310_000, // 0.00310000
      },
      {
        id: 20,
        body: "Numbers vary widely by methodology; transparency from large public miners skews the sample.",
        weight_percent: 24,
  ...
  // === Completed 6 ===
  {
    ...
    top_replies: [
      {
        id: 21,
        body: "They raise the cost of analysis significantly but are far from a magic shield, especially with reused addresses.",
        weight_percent: 39,
        amount_btc: 420_000, // 0.00420000
      },
      {
        id: 22,
        body: "The biggest leaks still come from KYC endpoints and poor operational security, not the on-chain graph alone.",
        weight_percent: 32,
...
// --- 對外 mock API ---
export async function mockBackendGetEvents(params: {
  page: number; // 1-based
  limit: number;
  ...
  const { page, limit, state, sortBy, orderBy, search, hashtag } = params;
  ...
  list = applySearchFilter(list.map(mapBackendEventToEventSummary), search).map(
    (ev) => {
...
export async function mockFetchEventsForHome(params: {
  ...
  const stateCode: 0 | 1 = status === "ongoing" ? 1 : 0;
