      ...
      <div className="border-border bg-bg mt-6 w-full max-w-3xl rounded-xl border p-4 md:p-6">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            spellCheck="false"
            className={cn(
              "bg-surface text-primary tx-14 mt-2 w-full rounded-lg border px-3 py-2 transition-all outline-none focus:ring-2",
        ...
        {event.event_type === "open" ? (
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              className={cn(
                "bg-surface text-primary tx-14 w-full resize-none rounded-lg border px-3 py-2 transition-all outline-none focus:ring-2",
                "border-border focus:ring-accent",
              )}
            />
      ...
      <div className="border-border bg-bg mt-6 w-full max-w-3xl rounded-xl border p-4 md:p-6">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="border-border bg-surface text-primary tx-14 focus:ring-accent mt-2 w-full rounded-lg border px-3 py-2 font-mono transition-all outline-none focus:ring-2"
          />
        </div>
      </div>
