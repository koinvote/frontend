      ...
      <div className="border-border bg-bg mt-6 w-full max-w-3xl rounded-xl border p-4 md:p-6">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={3}
            className="border-border bg-form-bg text-primary mt-2 w-full resize-none rounded-xl border px-3 py-2 font-mono text-sm leading-5 placeholder:font-sans placeholder:text-neutral-300 focus:ring-2 focus:ring-(--color-orange-500) focus:outline-none dark:placeholder:text-neutral-600"
          />
        </div>
      </div>
