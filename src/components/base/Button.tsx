    ...
    "active:scale-[0.98]",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        tone: "black",
        class:
          "bg-[var(--color-black)] text-[var(--color-white)] hover:opacity-95",
      },
      {
        appearance: "solid",
        tone: "orange",
      ...
      },
      {
        ...
        tone: "surface",
        class:
          "bg-white dark:text-white dark:bg-surface text-black border border-border hover:bg-surface/5",
      },
      ...
      },
      {
        ...
        tone: "white",
        class:
          "text-[var(--color-white)] border-[var(--color-white)]/90 hover:bg-white/5",
      },
      {
        appearance: "outline",
        tone: "black",
        class:
          "text-[var(--color-black)] border-[var(--color-black)]/90 hover:bg-black/5",
      },
      {
        appearance: "outline",
        tone: "orange",
      ...
      },
      {
        appearance: "outline",
        tone: "surface",
        class: "text-white border-border hover:bg-surface/5",
      },
    ],
    defaultVariants: {
      appearance: "solid",
