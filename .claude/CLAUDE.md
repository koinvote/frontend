...
- **i18n**: react-i18next (English/Chinese/Japanese/Korean/Spanish/German translations in `src/locals/`)
...
├── locals/           # i18n translation files (en.json, zh.json, ja.json, ko.json, es.json, de.json)
...
- Translation files: `src/locals/en.json`, `src/locals/zh.json`, `src/locals/ja.json`, `src/locals/ko.json`, `src/locals/es.json`, `src/locals/de.json`
